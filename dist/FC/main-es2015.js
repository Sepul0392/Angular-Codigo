...
let GestionarColegioAdminComponent = class GestionarColegioAdminComponent {
    ...
    deleteMateria() {
        ...
        this.AuthAdminService.deleteMateria(this.materiaToSave).subscribe(res => {
            //console.log(res);
            this.getOptions();
            this.materiaToSave = new _models_materia__WEBPACK_IMPORTED_MODULE_4__["MateriaI"]();
        });
    ...
    deleteGrado() {
        ...
        this.AuthAdminService.deleteGrade(this.gradoToSave).subscribe(res => {
            //console.log(res);
            this.getOptions();
            this.gradoToSave = new _models_grado__WEBPACK_IMPORTED_MODULE_3__["GradoI"]();
        });
        //window.location.reload();
    }
...
class ActividadI {
    constructor(id_actividad = 0, cont = 0, id_colegio = 0, id_docente = 0, id_materia = 0, id_grado = 0, id_competencia = 0, titulo_actividad = '', descripcion_actividad = '', id_contenidoREA = 0, video = 0, urlvideo = '', lectura = 0, urllectura = '', html = 0, urlhtml = '', Q1 = '', A11 = '', A12 = '', A13 = '', A14 = '', CA1 = 0, Q2 = '', A21 = '', A22 = '', A23 = '', A24 = '', CA2 = 0, Q3 = '', A31 = '', A32 = '', A33 = '', A34 = '', CA3 = 0, audio = 0, urlaudio = '', descripcion_test = '', id_taller = 0, taller = 0, urltaller = '', evaluacion = 0, descripcion_evaluacion = '', autor = '', id_autor = 0) {
...
class MateriaActivaI {
    constructor(id_materiaActiva = 0, nombre_materiaActiva = '', id_materia = 0, id_grado = 0, id_docente = 0, id_colegio = 0, url_imagen = '') {
